...
// `format: ['cjs']`, and package.json's `"ui-bridge-login-web": "./dist/...cjs"`),
...
// — `node_modules/.bin/ui-bridge-login-web`, which is exactly what
// `npx ... ui-bridge-login-web` resolves to — made the two differ: `main()` never
