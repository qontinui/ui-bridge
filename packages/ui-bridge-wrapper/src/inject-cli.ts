...
// `format: ['cjs']`, and package.json's `"ui-bridge-inject": "./dist/...cjs"`),
...
// — `node_modules/.bin/ui-bridge-inject`, which is exactly what
// `npx ... ui-bridge-inject` resolves to — made the two differ: `main()` never
