...
const TEST_VECTORS = [
  {
    ...
    positionZone: 'header',
    role: 'button',
    accessibleName: 'Menu' as string | undefined,
    sizeCategory: 'button',
    expectedHash: '332bcf7901518bd9',
  },
  {
    ...
    positionZone: 'main',
    role: 'textbox',
    accessibleName: 'Email' as string | undefined,
    sizeCategory: 'small',
    expectedHash: '314e89fb4502cc0b',
  },
  {
    name: 'Modal dialog',
    ...
    positionZone: 'modal',
    role: 'dialog',
    accessibleName: 'Confirm Delete' as string | undefined,
    sizeCategory: 'large',
    expectedHash: 'a94df5a4c8e52c9a',
  },
  {
    ...
    role: 'link',
    accessibleName: 'Dashboard' as string | undefined,
    sizeCategory: 'button',
    expectedHash: '8174509c620d7ab2',
  },
  {
    name: 'Footer link',
    ...
    positionZone: 'footer',
    role: 'link',
    accessibleName: 'Privacy Policy' as string | undefined,
    sizeCategory: 'button',
    expectedHash: '4873c371fbca621d',
  },
  {
  ...
  },
  {
    ...
    positionZone: 'main',
    role: 'combobox',
    accessibleName: 'Country' as string | undefined,
    sizeCategory: 'small',
    expectedHash: '6d8e56731c4558c7',
  },
  {
  ...
  },
  {
    ...
    positionZone: 'header',
    role: 'button',
    accessibleName: 'Close' as string | undefined,
    sizeCategory: 'icon',
    expectedHash: '87c26e378cea2acf',
  },
  {
    ...
    positionZone: 'main',
    role: 'checkbox',
    accessibleName: 'Remember me' as string | undefined,
    sizeCategory: 'icon',
    expectedHash: 'c2d6dff7e4d85f8f',
  },
];
