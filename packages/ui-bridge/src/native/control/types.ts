...
// Phase 2 (plan 2026-08-20-ui-bridge-action-declaration-shape). Same-package
// edge to the ONE validator implementation — see `native/control/action-executor.ts`.
 ...
 *
 * Mirrors `src/control/types.ts` `ComponentActionInvokeOptions`.
 */
