...
export { CONFIDENCE_BOOST, CONFIDENCE_PENALTY, CTR_CONFIG_VERSION, CTR_FILE_EXTENSION, CentralTargetRegistry, DEFAULT_SELECTOR_CONFIDENCE, MIN_CONFIDENCE_THRESHOLD, autoPopulateCtr, createCtrEntry, demoteSelector, getGlobalCtr, getViableSelectors, hasViableSelectors, promoteSelector, resetGlobalCtr, setGlobalCtr };
