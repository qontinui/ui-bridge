 ...
 * 200 + `found:false`.
 */
interface ElementExpectRequest {
 ...
 */
interface ElementExpectResponse {
 ...
 */
interface SpawnHeadlessRequest {
 ...
 */
interface SpawnHeadlessResponse {
...
interface UIBridgeServerHandlers {
    ...
    expectElement: (id: string, request: ElementExpectRequest) => Promise<APIResponse<ElementExpectResponse>>;
    spawnHeadless: (request: SpawnHeadlessRequest) => Promise<APIResponse<SpawnHeadlessResponse>>;
...
export { type APIResponse as A, type BrowserEventsResponse as B, type CORSOptions as C, type DOMChangeEvent as D, type ElementConditionSelector as E, type RateLimitOptions as R, type SpawnHeadlessRequest as S, type UIBridgeServerConfig as U, type WebSocketMessage as W, type UIBridgeServerHandlers as a, type CapabilitiesResponse as b, type ControlBatchRequest as c, type ControlBatchResponse as d, type ControlBatchStep as e, type ControlBatchStepResult as f, type ElementExpectRequest as g, type ElementExpectResponse as h, type EndpointCategory as i, type EndpointInfo as j, type RenderLogQuery as k, type RouteDefinition as l, type SpawnHeadlessResponse as m, type StateSummary as n, UI_BRIDGE_ROUTES as o, type WaitForElementByConditionRequest as p, type WaitForElementByConditionResponse as q, type WaitForElementPredicate as r, type WaitForElementRequest as s, type WaitForElementSuccessResponse as t, type WaitForRouteChangeRequest as u, type WaitForRouteChangeResponse as v, type WebSocketMessageType as w };
